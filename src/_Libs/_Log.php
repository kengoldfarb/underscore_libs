...
class _Log{
	 ...
	 * @var array 
	 */
	private static $logLevelToString = array(
		_FATAL => '_FATAL',
		_CRIT => '_CRIT',
		_WARN => '_WARN',
		_INFO => '_INFO',
	 ...
	 * @var object
	 */
	private static $lastDebugBacktrace = FALSE;
	 ...
	 */
	private static function writeToLog($level, $obj = NULL){
...
//			print_r(self::$lastDebugBacktrace);
	 ...
	 */
	private static function _doLog($msg){
		if(self::$logEcho){
			echo $msg . "\n";
			return TRUE;
		}else{
	...
	private static function _getFile($fullPath){
		$file = '';
